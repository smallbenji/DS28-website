...
namespace DS.HQ.Controllers
{
    ...
    [Route("/api/v1/group")]
    public class GroupApiController(DataDbContext dataDb, UserManager<User> userManager) : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                Users = userManager.Users.Where(x => !string.IsNullOrEmpty(x.GroupNumber)).GroupBy(x => x.GroupNumber).ToDictionary(x => x.Key, x => x.ToList())
            };
